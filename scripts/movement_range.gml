///arg0-origin node, node to pathfind from arg1-movement range, arg2-remaining actions
...
while(ds_priority_size(open)>0){
    ...
    //Qualifications: passable, doesn't have occupant, projected score is less than movement range, isn't ALREADY on closed list)
